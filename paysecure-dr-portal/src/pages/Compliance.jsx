...
const frameworkKeys = [
  ...
  { key: 'pci', label: 'PCI-DSS v4.0', short: 'PCI' },
  { key: 'npci', label: 'NPCI UPI', short: 'NPCI' },
{ key: 'localisation', label: 'India Data Localisation', short: 'LOC' },
];
  ...
  const filtered = useMemo(() => {
    ...
    if (frameworkFilter !== 'all') {
      result = result.filter((c) => {
        const status = c[frameworkFilter];
